...
INSERT INTO `data_type` VALUES (1,'String'),(2,'Integer');
...
INSERT INTO `dataset` VALUES (1,'Vehicle Recalls','60',NULL,'com.suchteam.opendata.CarRecallDataFetcher',NULL);
...
--
-- Dumping data for table `dataset_input`
--

LOCK TABLES `dataset_input` WRITE;
/*!40000 ALTER TABLE `dataset_input` DISABLE KEYS */;
/*!40000 ALTER TABLE `dataset_input` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `dataset_record`
--

LOCK TABLES `dataset_record` WRITE;
/*!40000 ALTER TABLE `dataset_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `dataset_record` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `dataset_value`
--

LOCK TABLES `dataset_value` WRITE;
/*!40000 ALTER TABLE `dataset_value` DISABLE KEYS */;
/*!40000 ALTER TABLE `dataset_value` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `subscribe_assertion`
--

LOCK TABLES `subscribe_assertion` WRITE;
/*!40000 ALTER TABLE `subscribe_assertion` DISABLE KEYS */;
/*!40000 ALTER TABLE `subscribe_assertion` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `subscribe_notified`
--

LOCK TABLES `subscribe_notified` WRITE;
/*!40000 ALTER TABLE `subscribe_notified` DISABLE KEYS */;
/*!40000 ALTER TABLE `subscribe_notified` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-03-01 11:09:27
